...
package starling.display
{
    ...
    public class DisplayObject extends EventDispatcher
    {
		...
		private var mAnchorPointX:Number;
		private var mAnchorPointY:Number;
        ...
        public function DisplayObject()
        {
            ...
            mX = mY = mOffsetX = mOffsetY = mPivotX = mPivotY = mAnchorPointX = mAnchorPointY = mContentSizeX = mContentSizeY = mRotation = mSkewX = mSkewY = 0.0;
        ...
        public function get transformationMatrix():Matrix
        {
            if (mOrientationChanged)
            {
                ...
                var _pivotX:Number = mPivotX;
				var _pivotY:Number = mPivotY;
                ...
                if (mSkewX == 0.0 && mSkewY == 0.0)
                {
                    ...
                    if (mRotation == 0.0)
                    {
                        mTransformationMatrix.setTo(mScaleX, 0.0, 0.0, mScaleY, 
                            mX + _offsetX - _pivotX * mScaleX + mOffsetX, mY + _offsetY - _pivotY * mScaleY + mOffsetY);
                    }
                    else
                    {
                        ...
                        var tx:Number  = mX + _offsetX - _pivotX * a - _pivotY * c + mOffsetX;
                        var ty:Number  = mY + _offsetY - _pivotX * b - _pivotY * d + mOffsetY;
                ...
                else
                {
                    ...
                    mTransformationMatrix.translate(mX + _offsetX + mOffsetX, mY + _offsetY + mOffsetY);
                    
                    if (_pivotX != 0.0 || _pivotY != 0.0)
                    {
                        // prepend pivot transformation
                        mTransformationMatrix.tx = mX - mTransformationMatrix.a * _pivotX + _offsetX
                                                      - mTransformationMatrix.c * _pivotY + mOffsetX;
                        mTransformationMatrix.ty = mY - mTransformationMatrix.b * _pivotX + _offsetY
                                                      - mTransformationMatrix.d * _pivotY + mOffsetY;
                    }
                }
            }
		...
		{
			mAnchorPointX = value.x;
			mAnchorPointY = value.y;
			mOrientationChanged = true;
			
			mPivotX = mContentSizeX * mAnchorPointX;
			mPivotY = mContentSizeY * (1.0 - mAnchorPointY);
		}
		...
		public function get anchorPoint():Point
		{
			...
			result.x = mAnchorPointX;
			result.y = mAnchorPointY;
			return result;
		}
		
		public function get anchorPointX():Number {
			return mAnchorPointX;
		}
		
		public function get anchorPointY():Number {
			return mAnchorPointY;
		}
		...
		public function get contentSizeX():Number {
			return mContentSizeX;
		}
		...
		public function get contentSizeY():Number {
			return mContentSizeY;
		}
