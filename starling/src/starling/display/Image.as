...
package starling.display
{
    ...
    public class Image extends Quad
    {
		...
		/** Helper object. */
		private static var sHelperPointA:Point = new Point();
		private static var sHelperPointB:Point = new Point();
        ...
        { 
            ...
            {
				if (mTexture.rotated != value.rotated)
				{
					if (mTexture.rotated)
					{
						//  0 - 1        2 - 0
						//  | / |  --->  | / |
						//  2 - 3        3 - 1
						mVertexData.getTexCoords(0, sHelperPointA);
						
						mVertexData.getTexCoords(2, sHelperPointB);
						mVertexData.setTexCoords(0, sHelperPointB.x, sHelperPointB.y);
						
						mVertexData.getTexCoords(3, sHelperPointB);
						mVertexData.setTexCoords(2, sHelperPointB.x, sHelperPointB.y);
						
						mVertexData.getTexCoords(1, sHelperPointB);
						mVertexData.setTexCoords(3, sHelperPointB.x, sHelperPointB.y);
						
						mVertexData.setTexCoords(1, sHelperPointA.x, sHelperPointA.y);
					}
					else
					{
						//  0 - 1        1 - 3
						...
						mVertexData.getTexCoords(3, sHelperPointB);
						mVertexData.setTexCoords(1, sHelperPointB.x, sHelperPointB.y);
						
						mVertexData.getTexCoords(2, sHelperPointB);
						mVertexData.setTexCoords(3, sHelperPointB.x, sHelperPointB.y);
						
						mVertexData.setTexCoords(2, sHelperPointA.x, sHelperPointA.y);
					}
				}
                mTexture = value;
