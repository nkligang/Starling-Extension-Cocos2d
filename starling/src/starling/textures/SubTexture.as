...
package starling.textures
{
    ...
    public class SubTexture extends Texture
    {
        ...
        public function SubTexture(parentTexture:Texture, region:Rectangle,
                                   ownsParent:Boolean=false, rotated:Boolean=false)
        {
        ...
        /** @inheritDoc */
        public override function get width():Number { return mRotated ? mParent.height * mClipping.height : mParent.width * mClipping.width; }
        
        /** @inheritDoc */
        public override function get height():Number { return mRotated ? mParent.width * mClipping.width : mParent.height * mClipping.height; }
        
        /** @inheritDoc */
        public override function get nativeWidth():Number { return mRotated ? mParent.nativeHeight * mClipping.height : mParent.nativeWidth * mClipping.width; }
        
        /** @inheritDoc */
        public override function get nativeHeight():Number { return mRotated ? mParent.nativeWidth * mClipping.width : mParent.nativeHeight * mClipping.height; }
		...
		/** @inheritDoc */
		public override function get rotated():Boolean { return mRotated; }
