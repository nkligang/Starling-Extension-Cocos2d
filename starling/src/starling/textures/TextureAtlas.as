...
package starling.textures
{
    ...
    public class TextureAtlas
    {
		...
		private var mTextureRotated:Dictionary;
        ...
        public function TextureAtlas(texture:Texture, atlasXml:XML=null)
        {
			...
			mTextureRotated = new Dictionary();
        ...
        protected function parseAtlasXml(atlasXml:XML):void
        {
            ...
            for each (var subTexture:XML in atlasXml.SubTexture)
            {
                ...
                addRegion(name, region, frame, false);
            }
        }
		
		public function parseAtlasDictionary(dict:Dictionary):void
		{
			...
			for (var name:String in frames)
			{
				...
				addRegion(name, region, frameTarget, rotated);
			}
		}
        ...
        public function getTexture(name:String):Texture
        {
            ...
            else return Texture.fromTexture(mAtlasTexture, region, mTextureFrames[name], mTextureRotated[name]);
        }
		...
		/** Returns whether the frame rectangle of a specific region is rotated or not. */
		public function isRotated(name:String):Boolean
		{
			return mTextureRotated[name];
		}
