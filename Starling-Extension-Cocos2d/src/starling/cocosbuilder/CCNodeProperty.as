...
package starling.cocosbuilder
{
	...
	public class CCNodeProperty
	{
		...
		public static const CCBNodePropertyIsEnabled:String                    = "isEnabled";
		...
		public static const CCBNodePropertyNormalSpriteFrame:String            = "normalSpriteFrame";
		...
		public function isEnabled():Boolean {
			var isEnabledObj:Object = mProperties[CCBNodePropertyIsEnabled];
			return isEnabledObj != null ? isEnabledObj as Boolean : false;
		}
		...
		/** Returns the alpha part of an ARGB color (0 - 1). */
		public static function getAlphaFloat(color:uint):Number { return ((color >> 24) & 0xff) * 0.00392156862746; }
